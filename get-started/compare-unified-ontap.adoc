...
NetApp AFX 针对高性能 NAS 和对象工作负载进行了优化。因此，它与AFF和FAS以及其他统一ONTAP存储系统存在差异。以下功能在NetApp AFX 中不可用；该列表按主要功能或功能领域进行组织。您还应该查看 AFX 的更新和变更。link:../release-notes/whats-new-9171.html["什么是新的"]根据你的版本。
