...
summary: 安装 AFX 硬件后，您可以完成 ONTAP 集群设置。此过程涉及您应按顺序执行的相关配置阶段。 
---
= 设置 AFX 存储系统ONTAP集群
:allow-uri-read: 
:icons: font
...
[role="lead"]
安装 AFX 硬件后，您可以完成 ONTAP 集群设置。此过程涉及您应按顺序执行的相关配置阶段。
...
在设置 ONTAP 集群之前，您应该查看核心 AFX 要求，以确保您拥有成功完成设置过程所需的所有必要信息和资源。
