...
[NOTE]
====
如果您正在使用 AI Data Engine（AIDE）部署 AFX 1K，则可以在安装完 AFX 系统后安装 AIDE 数据计算节点。

* 有关第三方服务器部署，请参见  https://docs.netapp.com/us-en/ai-data-engine/install-aide-server/aide-mde-server-hardware-requirements.html["对第三方服务器上带有 AIDE 软件的 AI Data Engine 的要求"^] 和  https://docs.netapp.com/us-en/ai-data-engine/install-setup/install-aide-as-software.html["在第三方服务器上安装 AIDE 软件"^]。
* 有关 NetApp DCN 部署，请参见 https://docs.netapp.com/us-en/ai-data-engine/install-dcn/aide-dcn-hardware-requirements.html["在 NetApp 提供的数据计算节点上对 AI Data Engine 的要求"^]。
