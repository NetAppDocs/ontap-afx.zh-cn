...
NOTE: 如果使用 AI Data Engine（AIDE）部署 AFX 1K，请在打开 AFX 系统电源后安装 AIDE 数据计算节点。请参见 link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["安装 AIDE 数据计算节点"] 了解更多信息。
