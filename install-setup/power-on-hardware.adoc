...
.下一步是什么？
打开 AFX 1K 存储系统电源后，根据您的部署选项完成设置：

* 有关专用 AFX 1K 存储系统部署，请转到 link:../install-setup/cluster-setup.html["设置 AFX 集群"]。
* 对于带有 AI Data Engine（AIDE）的 AFX 1K 部署，请安装 AIDE 第三方服务器或 NetApp 提供的数据计算节点：
