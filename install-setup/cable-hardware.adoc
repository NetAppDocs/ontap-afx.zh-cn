...
[[step-3-cable-the-cluster-ha-and-storage-connections-to-switch-a]]
...
+
image::../media/drw_afx_ha_cluster_storage_a_ieops-2779.svg[线缆控制器集群,800px,and storage to switch A]
...
[[step-4-cable-the-cluster-ha-and-storage-connections-to-switch-b]]
...
+
image::../media/drw_afx_ha_cluster_storage_b_ieops-2780.svg[线缆控制器集群,800px,and storage to switch B]
