...
在开始安装 AFX 2K 存储系统之前，请收集所需的网络信息
...
对于 Cisco Nexus 9808、Cisco Nexus 9332D-GX2 和 9364D-GX2A 交换机的安装和维护，请务必查看布线和网络要求。
...
.下一步是什么？
在查看网络要求后，您 link:cable-hardware.html["连接 AFX 2K 存储系统的控制器和存储架"]。
