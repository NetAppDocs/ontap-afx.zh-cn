...
CAUTION: AFX 存储系统不支持 link:../administer/revert-ontap.html["ONTAP恢复"] 运营。
...
link:https://docs.netapp.com/us-en/ontap/upgrade/automated-pre-checks.html["学习执行 ONTAP 自动升级前检查"^].
