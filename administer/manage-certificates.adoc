...
[[add-a-clientserver-certificate-or-local-certificate-authority]]
...
* https://docs.netapp.com/us-en/ontap/authentication/install-server-certificate-cluster-svm-ssl-server-task.html["在ONTAP中生成并安装 CA 签名的服务器证书"^]
